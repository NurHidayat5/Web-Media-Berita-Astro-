...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DgUoFst_.mjs';
import { manifest } from './manifest_EDpvEqXI.mjs';
...
const _args = {
    "middlewareSecret": "be84af16-ddfe-4be2-afcd-f77df44ea0da",
